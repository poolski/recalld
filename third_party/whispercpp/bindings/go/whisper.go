...
#cgo LDFLAGS: -L${SRCDIR}/../../build/src -L${SRCDIR}/../../build/ggml/src -L${SRCDIR}/../../build/ggml/src/ggml-blas -L${SRCDIR}/../../build/ggml/src/ggml-metal -lwhisper -lggml -lggml-base -lggml-cpu -lm -lstdc++
